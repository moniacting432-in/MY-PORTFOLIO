        ...
        <div className="container flex items-center justify-between">
            ...
            href="#hero">
                <span className="relative z-10">
                    <span className="text-glow text-foreground">Manisha</span> Portfolio
                </span>
            </a>
...
{""}
{isMenuOpen ? <X/>: <Menu size={24}/>}</button>



<div 
className={cn("fixed inset-0 bg-background/95 background-blur-md z-40 items-center justify-center",
